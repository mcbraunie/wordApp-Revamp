...
// let wordsFromCSV = getWordsFromFile();
let random_words = ['alphabet', 'dog', 'apple', 'chrysanthemum'];
...
// export { handleGuess, randomWord, checkIfGameWon, checkIfGameLost,
//         guessedWord, guessDifficulty, getSelection };